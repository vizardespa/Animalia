...
namespace ProgAvanzada_ProyectoFinal.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        {
            ViewBag.IdUsuario = new SelectList(db.TipoUsuario, "IdTipoUsuario", "Nombre");
            return View();
        }
        ...
        public ActionResult Create(Usuario usuario)
        {
            ...
            ViewBag.IdUsuario = new SelectList(db.TipoUsuario, "IdTipoUsuario", "Nombre", usuario.IdUsuario);
            return View(usuario);
        }
